--Digital music store datset analysis in PostgresSQL
...
select artist.artist_id, artist.name, count(artist.artist_id) as "no_of_track"
from artist 
...
from track
where milliseconds >(select avg(milliseconds) as "avg_millisecond" 
					 from track)
